...
ARTICLE_URL_FILE = '../article-lists/velamag-article-urls.json'
OUTPUT_FILE = '../article-info/velamag-articles-info.json'
WORKER_THREADS = 16
...
class LongformArticle:
    ...
    text: str = ''
    url: str = ''
    publication: str = 'velamag'
    model_publication: str = 'velamag'
