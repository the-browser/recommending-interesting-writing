...
ARTICLE_URL_FILE = '../article-lists/vulture-article-urls.json'
OUTPUT_FILE = '../article-info/vulture-articles-info.json'
WORKER_THREADS = 16
...
class LongformArticle:
    ...
    text: str = ''
    url: str = ''
    publication: str = "vulture"
    model_publication: str = "vulture"
