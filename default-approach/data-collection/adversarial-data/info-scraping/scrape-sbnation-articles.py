...
ARTICLE_URL_FILE = '../article-lists/sbnation-article-urls.json'
OUTPUT_FILE = '../article-info/sbnation-articles-info.json'
WORKER_THREADS = 16
...
class LongformArticle:
    ...
    text: str = ''
    url: str = ''
    publication: str = 'sbnation'
    model_publication: str = 'sbnation'
