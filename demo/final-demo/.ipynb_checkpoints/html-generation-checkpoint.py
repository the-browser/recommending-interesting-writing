...
parser.add_argument('--model_matrix_dir',
                    type=expand_path,
                    required=True,
                    help="This is required to load model matrices.")

parser.add_argument('--data_matrix_path',
                    type=expand_path,
                    required=True,
...
parser.add_argument('--html_output_dir',
                    type=expand_path,
                    required=True,
...
publication_emb = np.asarray([ 1.9955785,  2.0590432,  2.1761959, -2.0220742,  1.9912238,
                               -2.027111 , -2.2134302, -1.9901487,  2.0043654, -2.3093524,
                               -2.0107682,  2.002998 ,  2.0343666, -2.0904067,  2.4320478,
                                2.0393133,  2.0141761,  1.992825 ,  1.9798595, -2.0268648,
                               -1.9863509,  2.0398421, -1.9834707, -2.0138183,  1.997613 ], dtype=np.float32)
publication_bias = 0.45260596

word_article_path = args.data_matrix_path
word_articles = scipy.sparse.load_npz(word_article_path)

word_emb_path = args.model_matrix_path / "word_emb.npy"
word_emb = np.load(word_emb_path)
word_bias_path = args.model_matrix_path / "word_bias.npy"
...
final_html_path = args.output_html_dir / ending
