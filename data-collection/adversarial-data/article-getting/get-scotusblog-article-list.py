BASE_URL="https://www.scotusblog.com/page/"
N_ARTICLE_LINK_PAGES = 100
OUTPUT_FILE = 'article-lists/scotusblog-article-urls.json'
WORKER_THREADS = 16
            ...
            try:
                ...
                for article in articles: 
                    ...
                    if title is None or title.string is None:
                        continue
                    article_url = ScotusArticleUrl(url=link['href'], title=str(title.string.strip()) or '')
