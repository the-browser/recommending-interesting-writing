BASE_URL="https://newrepublic.com/latest?page="
N_ARTICLE_LINK_PAGES = 100
OUTPUT_FILE = 'article-lists/newrepublic-article-urls.json'
WORKER_THREADS = 16
    ...
    def run(self):
        for i in self.chunk:
            try:
                ...
                articles = soup.find_all('div', {'class': 'result-title'})
                for article in articles: 
                    ...
                    if title is None or title.string is None:
                        continue
                    article_url = NewRepublicArticleUrl(url="https://newrepublic.com" +link['href'], title=str(title.string.strip()) or '')
