...
ARTICLE_URL_FILE = '../article-lists/smithsonian-article-urls.json'
OUTPUT_FILE = '../article-info/smithsonian-articles-info.json'
WORKER_THREADS = 16
...
class LongformArticle:
    ...
    text: str = ''
    url: str = ''
    publication: str = 'smithsonian'
    model_publication: str = 'smithsonian'
